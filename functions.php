...
/**
  * Here a prebuild functions that you can use in hook file to handle masseges
  * 
  * - - - - - - - - - - - - - - - - - 
  *  Important Variables are at the end of this file
  *  thwy will help you in using this project 
  * - - - - - - - - - - - - - - - - - 
  * 
**/

//define your bot Api key ( getting it from config.php file )
define("TOKEN", $config['api_key'] ); 
...
//Variables may help you to use as function parameters for example 

$update     = json_decode(file_get_contents('php://input'));
@$message = $update->message; 

/**
 * Here a Variables that will make it easy for you to handle masseges
 * you can uncomment them and use them directly in hook file 
 * or you can use them as a reference to remember them
**/
